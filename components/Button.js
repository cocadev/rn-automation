          ...
          >
            <View style={styles.modalContainer}>
              <View style={styles.modal}>
                ...
                <TouchableOpacity style={{marginTop:35, justifyContent:'flex-end', width:'100%'}} onPress={()=>this.setState({modal:false})}>
        ...
        <View style={styles.modalContainer}>
          <View style={styles.modal}>
           ...
           <TouchableOpacity onPress={this._showDateTimePicker}>
            ...
            <Text style={[t.TitleText, {marginTop:20}]}>{UtilService.getDateTime (this.state.date)}</Text>
