      ...
      <ImageBackground source={pic.image_grad} style={styles.grad} >
         <View style={{ flexDirection:'row', justifyContent:'space-between', marginTop:5}}>
            <TouchableOpacity onPress={()=>Actions.pop()} style={{flexDirection:'row', alignItems:'center'}}>
               <MaterialCommunityIcons name={"keyboard-backspace"} size={30} color={Colors.WHITE} style={{marginRight:3}} />
            </TouchableOpacity>  
      ...
      <View style={styles.roundView}>
         ...
         <View style={{paddingHorizontal:12, borderRightColor:Colors.PURPLE, borderRightWidth:2}}>
           <View style={{flexDirection:'row', alignItems:'center'}}>
             ...
             <MaterialCommunityIcons name={"temperature-celsius"} size={16} color={Colors.PURPLE} style={{marginLeft:2}} />
           </View>
